                    ...
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            <ul class="footer-list address-content">
                                <li><i class="lnr lnr-map-marker"></i> Địa CHỉ: 30 Phùng Chí Kiên, Phường Hoàng Mai, Tỉnh Nghệ An.</li>
                                <li><i class="lnr lnr-envelope"></i><a href="thiennd.144010124006@vtc.edu.vn"> mail Us: thiennd.144010124006@vtc.edu.vn</a></li>
                                <li>
                                    <i class="lnr lnr-phone-handset"></i><a href="tel:+84773654031"> Phone: 0376218642 </a>
                                </li>
                            </ul>
    ...
    <div class="footer-bottom pb-30">
        <div class="container">
             ...
             <div class="copyright-text text-center">
                <p>Design by neihT © 2025 <a target="_blank" href="#">neihTComputer</a> All Rights Reserved.</p>
             </div>
        </div>
        <!-- Container End -->
    </div>
